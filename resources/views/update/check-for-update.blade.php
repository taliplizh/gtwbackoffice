...
<div class="progress">
    <div class="progress-bar progress-bar-primary progress-bar-striped progress-bar-animated" style="width:100%"><i class="fas fa-circle-notch fa-spin"></i> ตรวจสอบการอัพเดท </div>
</div>
            ...
            $(document).ready(function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#checkUpdate').html('ตรวจสอบการอัพเดท').delay(3000);
                    }
                });
            });
            ...
            $('#newInstall').click(function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        // alert(response);
                        swal("Success!", 'การอัพเดทเสร็จสมบรูณ์', "success");
                        $('#mediumModal').hide();
