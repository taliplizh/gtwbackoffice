    ...
    <div class="block" style="width: 95%;">
      ...
      <div class="row push">
                ...
                <div class="col-lg-1">
                    ...
                    <div class="col-lg-2">
                        <input  type="number" onKeyUp="if(isNaN(this.value)){ alert('กรุณากรอกตัวเลข '); this.value='';}" placeholder="กรอกเฉพาะตัวเลข" name = "LAUNDER_GETBACK_STAIN"  id="LAUNDER_GETBACK_STAIN" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" >
                    </div>
                    <div class="col-lg-1">
                    <label >กก.</label >
                    </div>
                <div class="col-lg-1">
                    ...
                    <div class="col-lg-2">
                        <input  type="number" onKeyUp="if(isNaN(this.value)){ alert('กรุณากรอกตัวเลข '); this.value='';}" placeholder="กรอกเฉพาะตัวเลข" name = "LAUNDER_GETBACK_INFECTIOUS"  id="LAUNDER_GETBACK_INFECTIOUS" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" >
                    </div>
                    <div class="col-lg-1">
                    <label >กก.</label >
                    </div>
      ...
      <div class="row push">
        ...
        <div align="right">
        <button type="submit"  class="btn btn-hero-sm btn-hero-info loadscreen" style="font-family: 'Kanit', sans-serif;font-weight:normal;"><i class="fas fa-save mr-2"></i>บันทึกข้อมูล</button>
