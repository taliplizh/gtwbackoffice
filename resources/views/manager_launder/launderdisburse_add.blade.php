                        ...
                        <thead style="background-color: #F0F8FF;">
                                        ...
                                        <tbody class="tbody1"> 
                                                ...
                                                <tr>         
                                                    ...
                                                    <td style="border: 1px solid black;"> 
                                                        <input type="number" onKeyUp="if(isNaN(this.value)){ alert('กรุณากรอกตัวเลข '); this.value='';}" placeholder="กรอกเฉพาะตัวเลข" name="LAUNDER_DIS_SUB_WAREHOUSE[]" id="LAUNDER_DIS_SUB_WAREHOUSE[]" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;" >
                                                    </td> 
                                                    <td style="border: 1px solid black;"> 
                                                    <input type="number" onKeyUp="if(isNaN(this.value)){ alert('กรุณากรอกตัวเลข '); this.value='';}" placeholder="กรอกเฉพาะตัวเลข" name="LAUNDER_DIS_SUB_AMOUNTRE[]" id="LAUNDER_DIS_SUB_AMOUNTRE[]" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;" >
                                                    </td>  
                                                    <td style="border: 1px solid black;"> 
                                                    <input type="number" onKeyUp="if(isNaN(this.value)){ alert('กรุณากรอกตัวเลข '); this.value='';}" placeholder="กรอกเฉพาะตัวเลข" name="LAUNDER_DIS_SUB_AMOUNT[]" id="LAUNDER_DIS_SUB_AMOUNT[]" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;" >
                                                    </td>       
...
$('.addRow1').on('click',function(){
    ...
    function addRow1(){
        var count = $('.tbody1').children('tr').length;
            var tr =  '<tr>'+         
            '<td style="border: 1px solid black;">'+ 
            '<select name="LAUNDER_DIS_SUB_TYPE[]" id="LAUNDER_DIS_SUB_TYPE1'+count+'" class="form-control input-sm " style=" font-family: \'Kanit\', sans-serif;" >'+
            '<option value="" >--กรุณาเลือก--</option>'+
            '@foreach ($infotypes as $infotype)'+
            '<option value="{{ $infotype->LAUNDER_TYPE_ID}}" >{{$infotype->LAUNDER_TYPE_NAME}}</option>'+
            '@endforeach'+   
            ...
            '</td>'+
            '<td style="border: 1px solid black;">'+ 
            '<input  type="number" placeholder="กรอกเฉพาะตัวเลข" name="LAUNDER_DIS_SUB_WAREHOUSE[]" id="LAUNDER_DIS_SUB_WAREHOUSE[]" class="form-control input-sm" style=" font-family: \'Kanit\', sans-serif;" >'+
            '</td>'+ 
            '<td style="border: 1px solid black;">'+   
            '<input  type="number" placeholder="กรอกเฉพาะตัวเลข" name="LAUNDER_DIS_SUB_AMOUNTRE[]" id="LAUNDER_DIS_SUB_AMOUNTRE[]" class="form-control input-sm" style=" font-family: \'Kanit\', sans-serif;" >'+  
            '</td>'+ 
            '<td style="border: 1px solid black;">'+ 
            '<input  type="number" placeholder="กรอกเฉพาะตัวเลข" name="LAUNDER_DIS_SUB_AMOUNT[]" id="LAUNDER_DIS_SUB_AMOUNT[]" class="form-control input-sm" style=" font-family: \'Kanit\', sans-serif;"  >'+
            '</td>'+  
