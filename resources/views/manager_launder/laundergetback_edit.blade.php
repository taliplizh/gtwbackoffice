    ...
    <div class="block" style="width: 95%;">
        <div class="block block-rounded block-bordered">
            <div class="block-header block-header-default">
                <h3 class="block-title" style="font-family: 'Kanit', sans-serif;"><B>แก้ไขข้อมูลรับผ้า</B></h3>
                <div align="right">
        ...
        <form  method="post" action="{{ route('launder.laundergetback_update_edit') }}" enctype="multipart/form-data">
        @csrf

        
        <input type="hidden" name = "idref_l"  id="idref_l" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{$idref_l}}" >
        <div class="row push">
                <div class="col-lg-1">
      ...
      <div class="row push">
                <div class="col-lg-1">
                    ...
                    @if($infodep == '')
                                ...
                                @foreach ($infodepselects as $infodepselect)
                                  @if($infol->LAUNDER_GETBACK_DEP == $infodepselect->LAUNDER_DEP_CODE )
                                        <option value="{{ $infodepselect->LAUNDER_DEP_CODE  }}" selected>{{ $infodepselect->LAUNDER_DEP_NAMECODE}}</option>
                                  @else
                ...
                <div class="col-lg-1">
                    ...
                    <div class="col-lg-2">
                        <input type="number" onKeyUp="if(isNaN(this.value)){ alert('กรุณากรอกตัวเลข '); this.value='';}" placeholder="กรอกเฉพาะตัวเลข" name = "LAUNDER_GETBACK_STAIN"  id="LAUNDER_GETBACK_STAIN" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{$infol->LAUNDER_GETBACK_STAIN}}" >
                    </div>
                    <div class="col-lg-1">
                    <label >กก.</label >
                    </div>
                <div class="col-lg-1">
                    ...
                    <div class="col-lg-2">
                        <input type="number" onKeyUp="if(isNaN(this.value)){ alert('กรุณากรอกตัวเลข '); this.value='';}" placeholder="กรอกเฉพาะตัวเลข"  name = "LAUNDER_GETBACK_INFECTIOUS"  id="LAUNDER_GETBACK_INFECTIOUS" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{$infol->LAUNDER_GETBACK_INFECTIOUS}}">
                    </div>
                    <div class="col-lg-1">
                    <label >กก.</label >
                    </div>
      ...
      <div class="row push">
        ...
        <div class="col-lg-2">
            <input  name = "LAUNDER_GETBACK_ROUND"  id="LAUNDER_GETBACK_ROUND" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{$infol->LAUNDER_GETBACK_ROUND}}" >
        ...
        <div align="right">
        <button type="submit"  class="btn btn-hero-sm btn-hero-info loadscreen"  style="font-family: 'Kanit', sans-serif;font-weight:normal;">บันทึกข้อมูล</button>
         <a href="{{ url('manager_launder/launder_getback')  }}" class="btn btn-hero-sm btn-hero-danger" style="font-family: 'Kanit', sans-serif;font-weight:normal;" onclick="return confirm('ต้องการที่จะยกเลิกการแก้ไข ?')" >ยกเลิก</a> 
         </div>    
