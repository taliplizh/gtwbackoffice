                        ...
                        <thead style="background-color: #F0F8FF;">
                                    ...
                                    <?php  $num++ ; ?>
                                                <tr>         
                                                    ...
                                                    <select name="LAUNDER_DIS_SUB_TYPE[]" id="LAUNDER_DIS_SUB_TYPE{{$num}}[]" class="form-control input-sm " style=" font-family: 'Kanit', sans-serif;" >
                                                        <option value="" >--กรุณาเลือก--</option>
                                                    ...
                                                    <td style="border: 1px solid black;"> 
                                                    <input type="number" onKeyUp="if(isNaN(this.value)){ alert('กรุณากรอกตัวเลข '); this.value='';}" placeholder="กรอกเฉพาะตัวเลข" name="LAUNDER_DIS_SUB_AMOUNT[]" id="LAUNDER_DIS_SUB_AMOUNT[]" value="{{$infochecksub->LAUNDER_DIS_SUB_AMOUNT}}" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;" >
                                                    </td>       
