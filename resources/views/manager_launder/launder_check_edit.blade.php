                        ...
                        <thead style="background-color: #F0F8FF;">
                                        ...
                                        @foreach ($infochecksubs as $infochecksub)
                                                <tr style="font-size: 14px">         
                                                    ...
                                                    <td style="border: 1px solid black;"> 
                                                    <input type="number" onKeyUp="if(isNaN(this.value)){ alert('กรุณากรอกตัวเลข '); this.value='';}" placeholder="กรอกเฉพาะตัวเลข"  name="LAUNDER_CHECK_SUB_AMOUNT[]" id="LAUNDER_CHECK_SUB_AMOUNT[]" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;" value="{{$infochecksub->LAUNDER_CHECK_SUB_AMOUNT}}">
                                                    </td>       
    ...
    function addRow1(){
        var count = $('.tbody1').children('tr').length;
            var tr =    '<tr style="font-size: 14px">'+         
                        ...
                        '</td>'+
                         '<td style="border: 1px solid black;">'+ 
                        '<input  type="number"  placeholder="กรอกเฉพาะตัวเลข" name="LAUNDER_CHECK_SUB_AMOUNT[]" id="LAUNDER_CHECK_SUB_AMOUNT[]" class="form-control input-sm" style=" font-family: \'Kanit\', sans-serif;" >'+
                        '</td>'+       
