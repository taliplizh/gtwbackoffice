  ...
  <div class="block block-rounded block-bordered">
    <div class="block-content">
      <h2 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;"><i class="fas fa-plus"></i>
        เพิ่มข้อมูลลิงค์ประชาสัมพันธ์</h2>
      <form method="post" action="{{route('admin.setupinfo.publicize_save')}}" enctype="multipart/form-data">
        @csrf()
        <div class="row push">
          <div class="col-lg-12">
            ...
            <div class="form-group">
              <div class="row">
                <div class="col-sm-3 mb-2 text-left">
                  <label>ชื่อลิงค์</label> <span style="color:red">*</span>
                </div>
                <div class="col-sm-9 mb-2">
                  <input required name="IPUB_NAME" id="IPUB_NAME" maxlength="255" class="form-control input-lg f-kanit">
                </div>
                <div class="col-sm-3 mb-2 text-left">
          ...
          <div class="col-lg-6">
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-sm-9 mb-2">
                  <input required type="url" name="IPUB_LINK" id="IPUB_LINK" class="form-control input-lg f-kanit"
                ...
                <div class="col-sm-9 mb-2">
                  <input required type="text" value="{{date('d/m/Y')}}" name="IPUB_DATE" id="IPUB_DATE"
                ...
                <div class="col-sm-9 mb-2">
                  <input required type="time" value="{{date('H:i:s')}}" name="IPUB_TIME" id="IPUB_TIME"
                ...
                <div class="col-sm-9 mb-2">
                  <div class="custom-control custom-switch custom-control-lg ">
                    <input type="checkbox" class="custom-control-input" value="1" id="IPUB_ACTIVE" name="IPUB_ACTIVE" checked>
        ...
        <div class="modal-footer">
          <div align="right">
            ...
            <a href="{{route('admin.setupinfo.publicize')}}" class="btn btn-hero-sm btn-hero-danger"
              onclick="return confirm('ต้องการที่จะยกเลิกเพิ่มข้อมูล ?')">ยกเลิก</a>
          </div>
        </div>
      </form>
    </div>
