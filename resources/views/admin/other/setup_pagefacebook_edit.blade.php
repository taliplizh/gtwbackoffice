...
<div class="content mb-5">
  <div class="block block-rounded block-bordered">
    <form method="post" action="{{route('admin.setupinfo.pagefacebook_update')}}" enctype="multipart/form-data">
      @csrf()
      <input type="hidden" name="id" value="{{$pagefacebook->IFP_ID}}">
      <div class="block-content">
        <h2 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;"><i class="fas fa-plus"></i>
          แก้ไขข้อมูลเพจเฟซบุ๊ก</h2>
        <div class="row push fs-16">
          ...
          <div class="col-sm-9 mb-2">
            <textarea class="form-control" name="IFP_PLUGIN" id="IFP_PLUGIN" required maxlength="400" cols="30"
              rows="8">{{$pagefacebook->IFP_PLUGIN}}</textarea>
          </div>
          <div class="col-lg-3 mb-2">
            <div class="form-group">
          ...
          <div class="col-sm-9 mb-2">
            <textarea class="form-control" name="IFP_DATASHOW" id="IFP_DATASHOW" required maxlength="1000" cols="30"
              rows="10">{{$pagefacebook->IFP_DATASHOW}}</textarea>
          </div>
          ...
          <div class="col-sm-9 mb-2">
            <div class="custom-control custom-switch custom-control-lg ">
              <input type="checkbox" class="custom-control-input" value="1" id="IFP_ACTIVE" name="IFP_ACTIVE" {{$pagefacebook->IFP_ACTIVE?'checked':''}}>
