...
$checkbook = DocumentController::checkmanagerbookinfoannounce($idbook,$user_id);
...
<form  method="post" action="{{ route('document.sendannounce') }}"  enctype="multipart/form-data"  class="needs-validation" novalidate>      
    @csrf
   ...
   <div class="col-md-5">
       ...
       <br>-->
        ...
        <div class="row" >
                                    ...
                                    <div class="block block-rounded block-bordered" style="width:100%;height:550px;">
...
<div class="modal-footer">
        ...
        <a  href="{{ url('general_document/genodocdocumentannounce/'.$iduser) }}" class="btn btn-hero-sm btn-hero-danger"  style="font-family: 'Kanit', sans-serif; font-size: 10px;font-size: 1.0rem;font-weight:normal;color:#FFFFFF;">ยกเลิก</a>
        </div>
...
<div id="send_modal" class="modal fade edit" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl">
   ...
   <form action="{{ route('document.saverpresentannounce') }}" method="post">
@csrf
...
<div id="retire_modal" class="modal fade edit" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl">
   ...
   <form action="{{ route('document.saveretireannounce') }}" method="post">
@csrf
