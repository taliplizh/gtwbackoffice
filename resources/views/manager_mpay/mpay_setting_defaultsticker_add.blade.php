...
<div class="block block-rounded block-bordered" style="width: 95%;margin:auto">
    <div class="block-header block-header-default">
        <h3 class="block-title">เพิ่มสติ๊กเกอร์</h3>
    </div>
    <div class="block-content">
                <form action="{{route('mpay.mpay_setting_defaultsticker_save')}}" method="POST">
                @csrf
                    <!-- Basic Elements -->
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="CAPY_STICK_NAME">ชื่อสติ๊กเกอร์</label> <span class="text-danger">*</span>
                                <input type="text" class="js-maxlength form-control f-kanit js-maxlength-enabled" id="CAPY_STICK_NAME" name="CAPY_STICK_NAME" placeholder="ชื่อสติ๊กเกอร์" required>
                            </div>
                            <div class="form-group">
                                <label for="CAPY_STICK_WIDTH">ความกว้าง (มม.)</label> <span class="text-danger">*</span>
                                <input type="number" class="js-maxlength form-control js-maxlength-enabled f-kanit" id="CAPY_STICK_WIDTH" min="0" name="CAPY_STICK_WIDTH" required placeholder="ความกว้าง">
                            </div>
                            <div class="form-group">
                                <label for="CAPY_STICK_HEIGHT">ความสูง (มม.)</label> <span class="text-danger">*</span>
                                <input type="number" class="js-maxlength form-control js-maxlength-enabled f-kanit" id="CAPY_STICK_HEIGHT" min="0" name="CAPY_STICK_HEIGHT" required placeholder="ความสูง">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="CAPY_STICK_BRAND_PRINTER">ยี่ห้อเครื่องปริ้น</label>
                                <input type="text" class="js-maxlength form-control js-maxlength-enabled f-kanit" id="CAPY_STICK_BRAND_PRINTER" name="CAPY_STICK_BRAND_PRINTER" placeholder="ยี่ห้อเครื่องปริ้น">
                            </div>
                            <div class="form-group">
                                <label for="CAPY_STICK_MODEL_PRINTER">โมเดลเครื่องปริ้น</label>
                                <input type="text" class="js-maxlength form-control js-maxlength-enabled f-kanit" id="CAPY_STICK_MODEL_PRINTER" name="CAPY_STICK_MODEL_PRINTER" placeholder="โมเดลเครื่องปริ้น">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <textarea type="text" style="height:90px;"
                                    ...
                                    name="CAPY_STICK_DETAIL" maxlength="255" placeholder="รายละเอียด..."></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row ">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <textarea type="text" style="height:300px;"
                                    ...
                                    name="CAPY_STICK_HTML_FORMAT" placeholder="HTML Format" required></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row items-push">
                        <div class="col-lg-12">
                            <div class="custom-control custom-switch custom-control-success mb-1">
                                <input type="checkbox" name="CAPY_STICK_FOR_LIST" class="custom-control-input" id="CAPY_STICK_FOR_LIST">
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" style="height:200px;"
                                    ...
                                    name="CPAY_STICKER_HTML_FORMAT_LIST" placeholder="HTML Format"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row items-push">
