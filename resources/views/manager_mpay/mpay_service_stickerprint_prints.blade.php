...
?>
    <div class="block d-print-none">
        <div class="block-header border ">
            <div class="block-title fs-18 fw-7">ปริ้นสติ๊กเกอร์</div> <a href="{{route('mpay.mpay_service_stickerprint_add')}}" class="btn btn-danger">กลับไปยังหน้าพิมพ์สติ๊กเกอร์</a>
