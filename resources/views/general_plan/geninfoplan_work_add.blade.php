...
$refnumber = ManagerplanController::refnumberWj();
...
<div class="block shadow" style="width:95%;margin:10px auto 20px;">
  <div class="block-content">
    ...
    <div class="block-content block-content-full">
      ...
      <form  method="post" action="{{ route('guest.geninfoplanwork_save') }}"  enctype="multipart/form-data">
  @csrf
...
<<<<<<< HEAD
        {{-- <select name="PLANWORK_STRATEGIC_ID" id="PLANWORK_STRATEGIC_ID" class="form-control input-lg js-example-basic-single strategic" style=" font-family: 'Kanit', sans-serif;" onchange="checkhrdepartment()"> --}}
...
<<<<<<< HEAD
    {{-- <select name="PLANWORK_TARGET_ID" id="PLANWORK_TARGET_ID" class="form-control input-lg js-example-basic-single goal" style=" font-family: 'Kanit', sans-serif;" onchange="checkhrdepartmentsub()"> --}}
...
<<<<<<< HEAD
    {{-- <select name="PLANWORK_KPI_ID" id="PLANWORK_KPI_ID" class="form-control input-lg js-example-basic-single metric" style=" font-family: 'Kanit', sans-serif;" onchange="checkhrdepartmentsubsub()"> --}}
...
>>>>>>> 62f266ce93539756531371e4df0de4462a6ca3d4
  ...
  <div class="col-lg-2">
  <input name="PLANWORK_CODE" id="PLANWORK_CODE" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;" value="{{$refnumber}}" >
  </div>
  ...
  <div class="col-lg-6">
  <input name="PLANWORK_HEAD" id="PLANWORK_HEAD" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;"  >
  </div> 
  ...
  <div class="col-lg-2">
  <input  name = "PLANWORK_DATE_BEGIN"  id="PLANWORK_DATE_BEGIN" class="form-control input-sm datepicker" style=" font-family: 'Kanit', sans-serif;" readonly>
  </div> 
  <div class="col-lg-2" style="text-align: left">
  <label >                           
  ถึงวันที่            
  ...
  <div class="col-lg-2">
  <input  name = "PLANWORK_DATE_END"  id="PLANWORK_DATE_END" class="form-control input-sm datepicker" style=" font-family: 'Kanit', sans-serif;" readonly>
  </div> 
  ...
  <div class="row push">
              ...
              <textarea id="PLANWORK_DETAIL" name="PLANWORK_DETAIL" rows="4" cols="50" class="form-control input-sm">
            ...
            <div class="block-content tab-content">
                  ...
                  <tbody class="tbody1"> 
                      ...
                      <tr>                                                         
                          <td>
                                  ...
                                  <select name="PLANWORK_HR_TEAM_ID[]" id="PLANWORK_HR_TEAM_ID0" class="form-control input-sm foo13">
                                      <option value="">--กรุณาเลือก--</option>
                ...
                <div class="tab-pane " id="object2" role="tabpanel">
                  ...
                  <tbody class="tbody2">
                          ...
                          <tr>
                              <td>                                   
                                      <select name="PLANWORK_HR_DEP_ID[]" id="PLANWORK_HR_DEP_ID0" class="form-control input-sm fo13">
                ...
                <div class="tab-pane" id="object3" role="tabpanel">
                  ...
                  <tr>        
                       <td>   
                          <select name="PLANWORK_HR_PERSON_ID[]" id="PLANWORK_HR_PERSON_ID0" class="form-control input-lg js-example-basic-single" style=" font-family: 'Kanit', sans-serif;" >
                              <option value="">--กรุณาเลือก--</option>
                ...
                <div class="tab-pane" id="object4" role="tabpanel">
                  ...
                  <tr>        
                       <td>   
                         <input name="PLANWORK_LIST_DETAIL[]" id="PLANWORK_LIST_DETAIL0" class="form-control input-lg js-example-basic-single"  >
                        </td>
                        <td style="text-align: center;"><a
                                class="btn btn-hero-sm btn-hero-danger remove"
                                style="color:#FFFFFF;"><i class="fa fa-trash-alt"></i></a>
