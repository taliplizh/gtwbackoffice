                            ...
                            <ul class="nav-main nav-main-horizontal nav-main-hover ">
                                ...
                                <li class="nav-main-item">
                                    ...
                                    <ul class="nav-main-submenu">
                                        <li class="nav-main-item">
                                            {{-- <a class="nav-main-link" href="{{ url('manager_crm/donation_fund') }}"> --}}
                                                <a class="nav-main-link{{ request()->is('manager_crm/donation_fund') ? ' active' : '' }}" href="{{url('manager_crm/donation_fund')}}">
                                                <span class="nav-main-link-name">กองทุน</span>
                                            </a>
                                        </li>
                                    <li class="nav-main-item">
                                        ...
                                        <li class="nav-main-item">
                                                <a class="nav-main-link{{ request()->is('manager_crm/openform') ? ' active' : '' }}" href="{{url('manager_crm/openform')}}">
                                                <span class="nav-main-link-name">เปิดฟังก์ชั่นฟอร์ม</span>
                                            </a>
                                        </li>
