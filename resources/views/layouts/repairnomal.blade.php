                    ...
                    <div >
                        ...
                        <div id="main-navigation" class="d-none d-lg-block ">
                            ...
                            <li class="nav-main-item"> 
                                ...
                                <li class="nav-main-item"> 
                                    <a class="nav-main-link{{ request()->is('manager_repairnomal/repairreinfosetting_typesystem') ? ' active' : '' }}" href="{{ url('manager_repairnomal/repairreinfosetting_typesystem') }}">
                                        <i class="nav-main-link-icon fa fa-calendar-alt"></i>
