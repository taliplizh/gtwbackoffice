    ...
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                ...
                <li>
                        <a href="#"><i class="fa fa-user"></i> ข้อมูลส่วนบุคคล<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{ url('personinfouser') }}">ข้อมูลส่วนบุคคล</a>
                            </li>
                            <li>
                                <a href="{{ url('personinfousereducat') }}">การศึกษา</a>
                            </li>
                            <li>
                                <a href="#">การทำงาน</a>
                            </li>
                            <li>
                                <a href="#">การได้รับรางวัล</a>
                            </li>
                            <li>
                                <a href="#">ความเชี่ยวชาญ</a>
                            </li>
                            <li>
                                <a href="#">การเปลี่ยนชื่อ</a>
                            </li>
                            <li>
                                <a href="#">เลื่อนขั้นเงินเดือน</a>
                            </li>
                            <li>
                                <a href="#">สังกัดทีมนำองค์กร</a>
                            </li>
                            <li>
                                <a href="#">อบรมเฉพาะทาง</a>
                            </li>
                            <li>
                                <a href="#">การต่อใบประกอบการ</a>
                            </li>
                            <li>
                                <a href="#">บัตรประชาชน</a>
                            </li>
                            <li>
                                <a href="#">บัตรข้าราชการ</a>
                            </li>
                            <li>
                                <a href="#">ข้อมูลทัวไปอื่นๆ</a>
                            </li>
                            <li>
                                <a href="#">ลายเซ็นต์</a>
                            </li>
