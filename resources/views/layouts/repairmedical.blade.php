                    ...
                    <div >
                        ...
                        <div id="main-navigation" class="d-none d-lg-block ">
                            ...
                            <li class="nav-main-item"> 
                                ...
                                <li class="nav-main-item"> 
                                    <a class="nav-main-link{{ request()->is('manager_repairmedical/repairmedinfosetting_typesystem') ? ' active' : '' }}" href="{{ url('manager_repairmedical/repairmedinfosetting_typesystem') }}">
                                        <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                        <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">ตั้งค่าระบบที่ต้องการแจ้งซ่อม</span>
