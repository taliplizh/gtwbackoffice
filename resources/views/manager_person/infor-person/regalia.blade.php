                    ...
                    <div class="table-responsive">
                        <table class="table-striped table-vcenter js-dataTable-simple" width="100%">
                            <thead style="background-color: #FFEBCD;">
                                <tr height="40">
                                    <th width="">
                                        <span class="font-table-title">ปีที่รับ</span>
                                    </th>
                                    <th width="">
                                        <span class="font-table-title">วันที่รับ</span>
                                    </th>
                                    <th width="">
                                        <span class="font-table-title">ยศ/ตำแหน่ง</span>
                                    </th>
                                    <th width="">
                                        <span class="font-table-title">ชั้นตราเครื่องราช</span>
                                    </th>
                                    <th width="">
                                        <span class="font-table-title">รก.ล.</span>
                                    </th>
                                    <th width="">
                                        <span class="font-table-title">รก.ด.</span>
                                    </th>
                                    <th width="">
                                        <span class="font-table-title">วันที่ประกาศ</span>
                                    </th>
                                    <th width="">
                                        <span class="font-table-title">เล่มที่</span>
                                    </th>
                                    <th width="">
                                        <span class="font-table-title">หน้าที่</span>
                                    </th>
                                    <th width="">
                                        <span class="font-table-title">ลำดับที่</span>
                                    </th>
                                    <th width="">
