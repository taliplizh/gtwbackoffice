...
<br><br><br><center>
     <div>
        ...
        <h2 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;">ตั้งค่าฟังก์ชั่นความเสี่ยง</h2>
...
<th class="text-font" style="border-color:#111111;text-align: center;">ฟังก์ชั่น</th>
