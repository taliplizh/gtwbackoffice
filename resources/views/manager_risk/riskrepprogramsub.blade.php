            ...
            <div class="block shadow-lg mt-5" style="width: 95%;">
                <div class="block block-rounded block-bordered">
                    <div class="block-header block-header-default">                        
                        <div align="left">
                            <h2 class="block-title" style="font-family:'Kanit',sans-serif;font-size:17px;font-weight:normal;"><B>รายละเอียดย่อย 1</B></h2>
                        </div> 
                        <div align="left">                       
                ...
                <table class="gwt-table table-striped table-vcenter js-dataTable-full" style="width: 100%;">
                    <thead style="background-color: #C39BD3;">
                        <tr height="40">
                            ...
                            <th class="text-font" style="text-align: center;">กลุ่มอุบัติการณ์</th>
                                    ...
                                    <div class="modal-dialog modal-xl">
                                        <div class="modal-content">
                                            <div class="modal-header bg-info shadow-lg">
                                                <h5 class="modal-title text-white" id="addModalModalLabel" style="font-family:'Kanit',sans-serif;font-size:17px;font-weight:normal;">แก้ไขรายละเอียดย่อย 1</h5>
                                            </div>
                                                    ...
                                                    <div class="row text-left">
                                                        <div class="col-md-6">   
                                                            <div class="form-group">
                                                                <label for="message-text" class="col-form-label">รายละเอียดย่อย 1:</label>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="" class="col-form-label">ลักษณะอุบัติการณ์ :</label>
