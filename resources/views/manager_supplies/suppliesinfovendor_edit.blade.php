...
?>
        ...
        <form  method="post" action="{{ route('msupplies.updatesuppliesvendor') }}" enctype="multipart/form-data">
        @csrf
        {{-- <div class="row push">                       
                <div class="col-lg-1">
        ...
        <button type="submit"  class="btn btn-hero-sm btn-hero-info" ><i class="fas fa-save mr-2"></i> บันทึกแก้ไขข้อมูล</button>
         <a href="{{ url('manager_supplies/setupsuppliesvendor')  }}" class="btn btn-hero-sm btn-hero-danger" onclick="return confirm('ต้องการที่จะยกเลิกการแก้ไขข้อมูล ?')" ><i class="fas fa-window-close mr-2"></i> ยกเลิก</a> 
         </div>    
