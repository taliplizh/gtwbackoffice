...
<div class="block-content block-content-full" align="left">
        ...
        <form  method="post" id="form_add" action="{{ route('msupplies.savesuppliesinfomation') }}" enctype="multipart/form-data">
        @csrf
...
<div class="medicine"> </div>  
       ...
       <div class="row push">
        ...
        <a href="{{ url('manager_supplies/suppliesinfo/'.$typedetail)  }}" class="btn btn-hero-sm btn-hero-danger" onclick="return confirm('ต้องการที่จะยกเลิกการเพิ่มข้อมูล ?')" ><i class="fas fa-window-close mr-2"></i>ยกเลิก</a> --}}
