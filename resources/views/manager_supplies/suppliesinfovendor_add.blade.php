...
<div class="content">
    <div class="block block-rounded block-bordered">
        ...
        <form  method="post" action="{{ route('msupplies.savesuppliesvendor') }}" enctype="multipart/form-data">
            @csrf
                {{-- <div class="row push">                       
                    <div class="col-lg-1">
                            ...
                            <div class="row push">                       
                                ...
                                <div class="modal-footer" id="submitbutton">
                                    <div align="right">
                                        ...
                                        <a href="{{ url('manager_supplies/setupsuppliesvendor')  }}" class="btn btn-hero-sm btn-hero-danger" onclick="return confirm('ต้องการที่จะยกเลิกการเพิ่มข้อมูล ?')" ><i class="fas fa-window-close mr-2"></i>ยกเลิก</a> 
                                    </div>
                                </div>
                        </form>  
