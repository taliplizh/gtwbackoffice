...
<div class="block-content block-content-full" align="left">
    ...
    <form  method="post" action="{{ route('msupplies.infosoldout_save') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row push">
            ...
            <div class="col-lg-3">
                <input name="SOLDOUT_NO" id="SOLDOUT_NO" class="form-control input-sm " value="{{$refnumber}} ">
            </div>
            <div class="col-lg-1">
                <label>วันที่ :</label>
            </div> 
            <div class="col-lg-2">
                <input name="SOLDOUT_DATE" id="SOLDOUT_DATE" class="form-control input-lg datepicker" data-date-format="mm/dd/yyyy" style="font-family:'Kanit',sans-serif;font-size:13px;" value="{{formate($datenow)}}" readonly> 
            </div> 
            ...
            <div class="row push">
                ...
                <div class="col-lg-2">
                    <input name="SOLDOUT_PRICE" id="SOLDOUT_PRICE" class="form-control input-sm " >
                </div>  
            </div>
            <div class="row push">
                <div class="col-lg-2">
                ...
                <div class="col-lg-10">
                    <input name="SOLDOUT_DETAIL" id="SOLDOUT_DETAIL" class="form-control input-sm " >
                </div>         
            </div>
        ...
        <div class="row push">
            ...
            <div class="col-lg-10">
                <input name="SOLDOUT_COMMENT" id="SOLDOUT_COMMENT" class="form-control input-sm " >
            </div>         
        </div>
