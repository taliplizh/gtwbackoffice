...
<div class="content mx-1 ml-3" >
    ...
    <div class="block block-rounded block-bordered">
        ...
        <div class="block-content block-content-full">
            <form action="{{route('gen_risk.risk_notify_recheck_update')}}" method="post" id="form" enctype="multipart/form-data">
                @csrf 
                ...
                <div class="modal-footer">
                    <div align="right">
                        ...
                        <a href="{{route('gen_risk.risk_notify_recheck',[$riskrecheck->RISK_RECHECK_RISKID,$iduser])}}"
