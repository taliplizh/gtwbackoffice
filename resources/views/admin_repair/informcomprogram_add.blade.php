...
<div class="content">
    <div class="block block-rounded block-bordered">
        <div class="block-content"> 
            <h2 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;"><i class="fas fa-plus"></i> เพิ่มโปรแกรมที่ใช้ติดตั้ง</h2>    
        <form  method="post" action="{{ route('admin.saveinformcomprogram') }}" enctype="multipart/form-data">
            @csrf
            <div class="row push">
                <div class="col-lg-2">
                ...
                <div class="col-lg-4">
                    <input  name = "PRO_NAME"  id="PRO_NAME" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="check_proname();">
                ...
                <div class="col-lg-4">
                    <input  name = "PRO_VER"  id="PRO_VER" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="check_prover();">
            ...
            <div align="right">
                ...
                <a href="{{ url('admin_repair/Setupinformcomprogram')  }}" class="btn btn-hero-sm btn-hero-danger" onclick="return confirm('ต้องการที่จะยกเลิกการเพิ่มข้อมูล ?')" ><i class="fas fa-window-close"></i> &nbsp;ยกเลิก</a> 
            </div>
        </div>
        </form>  
