...
class ManagerlaunderController extends Controller
{
    public function dashboard()
    {
        ...
        // $year = date('Y');
        $getback = DB::table('launder_getback')->where('LAUNDER_GETBACK_DATE','like',$year.'%')->count();
        // dd($getback);
        $check = DB::table('launder_check')->where('LAUNDER_CHECK_DATE','like',$year.'%')->count();
        $dis = DB::table('launder_dis')->where('LAUNDER_DIS_DATE','like',$year.'%')->count();
        $withdrow = DB::table('launder_withdrow')->where('LAUNDER_WITHDROW_DATE','like',$year.'%')->count();

        // $year = date('Y');
        $d_1 = DB::table('launder_getback')->where('LAUNDER_GETBACK_DEP','=','1')->where('LAUNDER_GETBACK_DATE','like',$year.'%')->count();
        $d_2 = DB::table('launder_getback')->where('LAUNDER_GETBACK_DEP','=','2')->where('LAUNDER_GETBACK_DATE','like',$year.'%')->count();
        $d_3 = DB::table('launder_getback')->where('LAUNDER_GETBACK_DEP','=','3')->where('LAUNDER_GETBACK_DATE','like',$year.'%')->count();
        $d_4 = DB::table('launder_getback')->where('LAUNDER_GETBACK_DEP','=','4')->where('LAUNDER_GETBACK_DATE','like',$year.'%')->count();
        $d_5 = DB::table('launder_getback')->where('LAUNDER_GETBACK_DEP','=','5')->where('LAUNDER_GETBACK_DATE','like',$year.'%')->count();
        $d_6 = DB::table('launder_getback')->where('LAUNDER_GETBACK_DEP','=','6')->where('LAUNDER_GETBACK_DATE','like',$year.'%')->count();
        $d_7 = DB::table('launder_getback')->where('LAUNDER_GETBACK_DEP','=','7')->where('LAUNDER_GETBACK_DATE','like',$year.'%')->count();
        $d_8 = DB::table('launder_getback')->where('LAUNDER_GETBACK_DEP','=','8')->where('LAUNDER_GETBACK_DATE','like',$year.'%')->count();
        $d_9 = DB::table('launder_getback')->where('LAUNDER_GETBACK_DEP','=','9')->where('LAUNDER_GETBACK_DATE','like',$year.'%')->count();
        $d_10 = DB::table('launder_getback')->where('LAUNDER_GETBACK_DEP','=','10')->where('LAUNDER_GETBACK_DATE','like',$year.'%')->count();
        $d_11 = DB::table('launder_getback')->where('LAUNDER_GETBACK_DEP','=','11')->where('LAUNDER_GETBACK_DATE','like',$year.'%')->count();
        $d_12 = DB::table('launder_getback')->where('LAUNDER_GETBACK_DEP','=','12')->where('LAUNDER_GETBACK_DATE','like',$year.'%')->count();
        $d_13 = DB::table('launder_getback')->where('LAUNDER_GETBACK_DEP','=','13')->where('LAUNDER_GETBACK_DATE','like',$year.'%')->count();
        $d_14 = DB::table('launder_getback')->where('LAUNDER_GETBACK_DEP','=','14')->where('LAUNDER_GETBACK_DATE','like',$year.'%')->count();
        $d_15 = DB::table('launder_getback')->where('LAUNDER_GETBACK_DEP','=','15')->where('LAUNDER_GETBACK_DATE','like',$year.'%')->count();
        $d_16 = DB::table('launder_getback')->where('LAUNDER_GETBACK_DEP','=','16')->where('LAUNDER_GETBACK_DATE','like',$year.'%')->count();
        $d_17 = DB::table('launder_getback')->where('LAUNDER_GETBACK_DEP','=','17')->where('LAUNDER_GETBACK_DATE','like',$year.'%')->count();
        $d_18 = DB::table('launder_getback')->where('LAUNDER_GETBACK_DEP','=','18')->where('LAUNDER_GETBACK_DATE','like',$year.'%')->count();
        $d_19 = DB::table('launder_getback')->where('LAUNDER_GETBACK_DEP','=','19')->where('LAUNDER_GETBACK_DATE','like',$year.'%')->count();
        $d_20 = DB::table('launder_getback')->where('LAUNDER_GETBACK_DEP','=','20')->where('LAUNDER_GETBACK_DATE','like',$year.'%')->count();
        $d_21 = DB::table('launder_getback')->where('LAUNDER_GETBACK_DEP','=','21')->where('LAUNDER_GETBACK_DATE','like',$year.'%')->count();
        $d_22 = DB::table('launder_getback')->where('LAUNDER_GETBACK_DEP','=','22')->where('LAUNDER_GETBACK_DATE','like',$year.'%')->count();
        $d_23 = DB::table('launder_getback')->where('LAUNDER_GETBACK_DEP','=','23')->where('LAUNDER_GETBACK_DATE','like',$year.'%')->count();
        $d_24 = DB::table('launder_getback')->where('LAUNDER_GETBACK_DEP','=','24')->where('LAUNDER_GETBACK_DATE','like',$year.'%')->count();
        $d_25 = DB::table('launder_getback')->where('LAUNDER_GETBACK_DEP','=','25')->where('LAUNDER_GETBACK_DATE','like',$year.'%')->count();
        $d_26 = DB::table('launder_getback')->where('LAUNDER_GETBACK_DEP','=','26')->where('LAUNDER_GETBACK_DATE','like',$year.'%')->count();
        $d_27 = DB::table('launder_getback')->where('LAUNDER_GETBACK_DEP','=','27')->where('LAUNDER_GETBACK_DATE','like',$year.'%')->count();
        $d_28 = DB::table('launder_getback')->where('LAUNDER_GETBACK_DEP','=','28')->where('LAUNDER_GETBACK_DATE','like',$year.'%')->count();
        $d_29 = DB::table('launder_getback')->where('LAUNDER_GETBACK_DEP','=','29')->where('LAUNDER_GETBACK_DATE','like',$year.'%')->count();
        $d_30 = DB::table('launder_getback')->where('LAUNDER_GETBACK_DEP','=','30')->where('LAUNDER_GETBACK_DATE','like',$year.'%')->count();  
        $d_31 = DB::table('launder_getback')->where('LAUNDER_GETBACK_DEP','=','31')->where('LAUNDER_GETBACK_DATE','like',$year.'%')->count(); 
        $d_32 = DB::table('launder_getback')->where('LAUNDER_GETBACK_DEP','=','32')->where('LAUNDER_GETBACK_DATE','like',$year.'%')->count(); 
        $d_33 = DB::table('launder_getback')->where('LAUNDER_GETBACK_DEP','=','33')->where('LAUNDER_GETBACK_DATE','like',$year.'%')->count(); 
        $d_34 = DB::table('launder_getback')->where('LAUNDER_GETBACK_DEP','=','34')->where('LAUNDER_GETBACK_DATE','like',$year.'%')->count(); 
        $d_35 = DB::table('launder_getback')->where('LAUNDER_GETBACK_DEP','=','35')->where('LAUNDER_GETBACK_DATE','like',$year.'%')->count(); 
        $d_36 = DB::table('launder_getback')->where('LAUNDER_GETBACK_DEP','=','36')->where('LAUNDER_GETBACK_DATE','like',$year.'%')->count(); 
        $d_37 = DB::table('launder_getback')->where('LAUNDER_GETBACK_DEP','=','37')->where('LAUNDER_GETBACK_DATE','like',$year.'%')->count(); 
        $d_38 = DB::table('launder_getback')->where('LAUNDER_GETBACK_DEP','=','38')->where('LAUNDER_GETBACK_DATE','like',$year.'%')->count(); 
        $d_39 = DB::table('launder_getback')->where('LAUNDER_GETBACK_DEP','=','39')->where('LAUNDER_GETBACK_DATE','like',$year.'%')->count();      
        $d_40 = DB::table('launder_getback')->where('LAUNDER_GETBACK_DEP','=','40')->where('LAUNDER_GETBACK_DATE','like',$year.'%')->count(); 
        $getback_chart = DB::table('launder_getback')
                    ...
                    ->where('LAUNDER_GETBACK_DATE','like',$year.'%')
                    ->groupBy('LAUNDER_GETBACK_DEP')
                    ->get();
// dd($getback_chart);
        $o_1 = DB::table('launder_check')->where('LAUNDER_CHECK_FROM','=','1')->where('LAUNDER_CHECK_DATE','like',$year.'%')->count();
        $o_2 = DB::table('launder_check')->where('LAUNDER_CHECK_FROM','=','2')->where('LAUNDER_CHECK_DATE','like',$year.'%')->count();       
        $check_chart = DB::table('launder_check')
                    ->select(DB::raw('count(*) as checkdep_count,LAUNDER_CHECK_FROM'),'LAUNDER_CHECK_FROM') 
                    ->where('LAUNDER_CHECK_DATE','like',$year.'%')
                    ->groupBy('LAUNDER_CHECK_FROM')
                    ->get();

            $di_1 = DB::table('launder_dis')->where('LAUNDER_DIS_DEP','=','1')->where('LAUNDER_DIS_DATE','like',$year.'%')->count();
            $di_2 = DB::table('launder_dis')->where('LAUNDER_DIS_DEP','=','2')->where('LAUNDER_DIS_DATE','like',$year.'%')->count();
            $di_3 = DB::table('launder_dis')->where('LAUNDER_DIS_DEP','=','3')->where('LAUNDER_DIS_DATE','like',$year.'%')->count();
            $di_4 = DB::table('launder_dis')->where('LAUNDER_DIS_DEP','=','4')->where('LAUNDER_DIS_DATE','like',$year.'%')->count();
            $di_5 = DB::table('launder_dis')->where('LAUNDER_DIS_DEP','=','5')->where('LAUNDER_DIS_DATE','like',$year.'%')->count();
            $di_6 = DB::table('launder_dis')->where('LAUNDER_DIS_DEP','=','6')->where('LAUNDER_DIS_DATE','like',$year.'%')->count();
            $di_7 = DB::table('launder_dis')->where('LAUNDER_DIS_DEP','=','7')->where('LAUNDER_DIS_DATE','like',$year.'%')->count();
            $di_8 = DB::table('launder_dis')->where('LAUNDER_DIS_DEP','=','8')->where('LAUNDER_DIS_DATE','like',$year.'%')->count();
            $di_9 = DB::table('launder_dis')->where('LAUNDER_DIS_DEP','=','9')->where('LAUNDER_DIS_DATE','like',$year.'%')->count();
            $di_10 = DB::table('launder_dis')->where('LAUNDER_DIS_DEP','=','10')->where('LAUNDER_DIS_DATE','like',$year.'%')->count();
            $di_11 = DB::table('launder_dis')->where('LAUNDER_DIS_DEP','=','11')->where('LAUNDER_DIS_DATE','like',$year.'%')->count();
            $di_12 = DB::table('launder_dis')->where('LAUNDER_DIS_DEP','=','12')->where('LAUNDER_DIS_DATE','like',$year.'%')->count();
            $di_13 = DB::table('launder_dis')->where('LAUNDER_DIS_DEP','=','13')->where('LAUNDER_DIS_DATE','like',$year.'%')->count();
            $di_14 = DB::table('launder_dis')->where('LAUNDER_DIS_DEP','=','14')->where('LAUNDER_DIS_DATE','like',$year.'%')->count();
            $di_15 = DB::table('launder_dis')->where('LAUNDER_DIS_DEP','=','15')->where('LAUNDER_DIS_DATE','like',$year.'%')->count();
            $di_16 = DB::table('launder_dis')->where('LAUNDER_DIS_DEP','=','16')->where('LAUNDER_DIS_DATE','like',$year.'%')->count();
            $di_17 = DB::table('launder_dis')->where('LAUNDER_DIS_DEP','=','17')->where('LAUNDER_DIS_DATE','like',$year.'%')->count();
            $di_18 = DB::table('launder_dis')->where('LAUNDER_DIS_DEP','=','18')->where('LAUNDER_DIS_DATE','like',$year.'%')->count();
            $di_19 = DB::table('launder_dis')->where('LAUNDER_DIS_DEP','=','19')->where('LAUNDER_DIS_DATE','like',$year.'%')->count();
            $di_20 = DB::table('launder_dis')->where('LAUNDER_DIS_DEP','=','20')->where('LAUNDER_DIS_DATE','like',$year.'%')->count();
            $di_21 = DB::table('launder_dis')->where('LAUNDER_DIS_DEP','=','21')->where('LAUNDER_DIS_DATE','like',$year.'%')->count();
            $di_22 = DB::table('launder_dis')->where('LAUNDER_DIS_DEP','=','22')->where('LAUNDER_DIS_DATE','like',$year.'%')->count();
            $di_23 = DB::table('launder_dis')->where('LAUNDER_DIS_DEP','=','23')->where('LAUNDER_DIS_DATE','like',$year.'%')->count();
            $di_24 = DB::table('launder_dis')->where('LAUNDER_DIS_DEP','=','24')->where('LAUNDER_DIS_DATE','like',$year.'%')->count();
            $di_25 = DB::table('launder_dis')->where('LAUNDER_DIS_DEP','=','25')->where('LAUNDER_DIS_DATE','like',$year.'%')->count();
            $di_26 = DB::table('launder_dis')->where('LAUNDER_DIS_DEP','=','26')->where('LAUNDER_DIS_DATE','like',$year.'%')->count();
            $di_27 = DB::table('launder_dis')->where('LAUNDER_DIS_DEP','=','27')->where('LAUNDER_DIS_DATE','like',$year.'%')->count();
            $di_28 = DB::table('launder_dis')->where('LAUNDER_DIS_DEP','=','28')->where('LAUNDER_DIS_DATE','like',$year.'%')->count();
            $di_29 = DB::table('launder_dis')->where('LAUNDER_DIS_DEP','=','29')->where('LAUNDER_DIS_DATE','like',$year.'%')->count();
            $di_30 = DB::table('launder_dis')->where('LAUNDER_DIS_DEP','=','30')->where('LAUNDER_DIS_DATE','like',$year.'%')->count();  
            $di_31 = DB::table('launder_dis')->where('LAUNDER_DIS_DEP','=','31')->where('LAUNDER_DIS_DATE','like',$year.'%')->count(); 
            $di_32 = DB::table('launder_dis')->where('LAUNDER_DIS_DEP','=','32')->where('LAUNDER_DIS_DATE','like',$year.'%')->count(); 
            $di_33 = DB::table('launder_dis')->where('LAUNDER_DIS_DEP','=','33')->where('LAUNDER_DIS_DATE','like',$year.'%')->count(); 
            $di_34 = DB::table('launder_dis')->where('LAUNDER_DIS_DEP','=','34')->where('LAUNDER_DIS_DATE','like',$year.'%')->count(); 
            $di_35 = DB::table('launder_dis')->where('LAUNDER_DIS_DEP','=','35')->where('LAUNDER_DIS_DATE','like',$year.'%')->count(); 
            $di_36 = DB::table('launder_dis')->where('LAUNDER_DIS_DEP','=','36')->where('LAUNDER_DIS_DATE','like',$year.'%')->count(); 
            $di_37 = DB::table('launder_dis')->where('LAUNDER_DIS_DEP','=','37')->where('LAUNDER_DIS_DATE','like',$year.'%')->count(); 
            $di_38 = DB::table('launder_dis')->where('LAUNDER_DIS_DEP','=','38')->where('LAUNDER_DIS_DATE','like',$year.'%')->count(); 
            $di_39 = DB::table('launder_dis')->where('LAUNDER_DIS_DEP','=','39')->where('LAUNDER_DIS_DATE','like',$year.'%')->count();      
            $di_40 = DB::table('launder_dis')->where('LAUNDER_DIS_DEP','=','40')->where('LAUNDER_DIS_DATE','like',$year.'%')->count(); 

            $dw_1 = DB::table('launder_withdrow')->where('LAUNDER_WITHDROW_DEP_SUB_SUB_ID','=','1')->where('LAUNDER_WITHDROW_DATE','like',$year.'%')->count();
            $dw_2 = DB::table('launder_withdrow')->where('LAUNDER_WITHDROW_DEP_SUB_SUB_ID','=','2')->where('LAUNDER_WITHDROW_DATE','like',$year.'%')->count();
            $dw_3 = DB::table('launder_withdrow')->where('LAUNDER_WITHDROW_DEP_SUB_SUB_ID','=','3')->where('LAUNDER_WITHDROW_DATE','like',$year.'%')->count();
            $dw_4 = DB::table('launder_withdrow')->where('LAUNDER_WITHDROW_DEP_SUB_SUB_ID','=','4')->where('LAUNDER_WITHDROW_DATE','like',$year.'%')->count();
            $dw_5 = DB::table('launder_withdrow')->where('LAUNDER_WITHDROW_DEP_SUB_SUB_ID','=','5')->where('LAUNDER_WITHDROW_DATE','like',$year.'%')->count();
            $dw_6 = DB::table('launder_withdrow')->where('LAUNDER_WITHDROW_DEP_SUB_SUB_ID','=','6')->where('LAUNDER_WITHDROW_DATE','like',$year.'%')->count();
            $dw_7 = DB::table('launder_withdrow')->where('LAUNDER_WITHDROW_DEP_SUB_SUB_ID','=','7')->where('LAUNDER_WITHDROW_DATE','like',$year.'%')->count();
            $dw_8 = DB::table('launder_withdrow')->where('LAUNDER_WITHDROW_DEP_SUB_SUB_ID','=','8')->where('LAUNDER_WITHDROW_DATE','like',$year.'%')->count();
            $dw_9 = DB::table('launder_withdrow')->where('LAUNDER_WITHDROW_DEP_SUB_SUB_ID','=','9')->where('LAUNDER_WITHDROW_DATE','like',$year.'%')->count();
            $dw_10 = DB::table('launder_withdrow')->where('LAUNDER_WITHDROW_DEP_SUB_SUB_ID','=','10')->where('LAUNDER_WITHDROW_DATE','like',$year.'%')->count();
            $dw_11 = DB::table('launder_withdrow')->where('LAUNDER_WITHDROW_DEP_SUB_SUB_ID','=','11')->where('LAUNDER_WITHDROW_DATE','like',$year.'%')->count();
            $dw_12 = DB::table('launder_withdrow')->where('LAUNDER_WITHDROW_DEP_SUB_SUB_ID','=','12')->where('LAUNDER_WITHDROW_DATE','like',$year.'%')->count();
            $dw_13 = DB::table('launder_withdrow')->where('LAUNDER_WITHDROW_DEP_SUB_SUB_ID','=','13')->where('LAUNDER_WITHDROW_DATE','like',$year.'%')->count();
            $dw_14 = DB::table('launder_withdrow')->where('LAUNDER_WITHDROW_DEP_SUB_SUB_ID','=','14')->where('LAUNDER_WITHDROW_DATE','like',$year.'%')->count();
            $dw_15 = DB::table('launder_withdrow')->where('LAUNDER_WITHDROW_DEP_SUB_SUB_ID','=','15')->where('LAUNDER_WITHDROW_DATE','like',$year.'%')->count();
            $dw_16 = DB::table('launder_withdrow')->where('LAUNDER_WITHDROW_DEP_SUB_SUB_ID','=','16')->where('LAUNDER_WITHDROW_DATE','like',$year.'%')->count();
            $dw_17 = DB::table('launder_withdrow')->where('LAUNDER_WITHDROW_DEP_SUB_SUB_ID','=','17')->where('LAUNDER_WITHDROW_DATE','like',$year.'%')->count();
            $dw_18 = DB::table('launder_withdrow')->where('LAUNDER_WITHDROW_DEP_SUB_SUB_ID','=','18')->where('LAUNDER_WITHDROW_DATE','like',$year.'%')->count();
            $dw_19 = DB::table('launder_withdrow')->where('LAUNDER_WITHDROW_DEP_SUB_SUB_ID','=','19')->where('LAUNDER_WITHDROW_DATE','like',$year.'%')->count();
            $dw_20 = DB::table('launder_withdrow')->where('LAUNDER_WITHDROW_DEP_SUB_SUB_ID','=','20')->where('LAUNDER_WITHDROW_DATE','like',$year.'%')->count();
            $dw_21 = DB::table('launder_withdrow')->where('LAUNDER_WITHDROW_DEP_SUB_SUB_ID','=','21')->where('LAUNDER_WITHDROW_DATE','like',$year.'%')->count();
            $dw_22 = DB::table('launder_withdrow')->where('LAUNDER_WITHDROW_DEP_SUB_SUB_ID','=','22')->where('LAUNDER_WITHDROW_DATE','like',$year.'%')->count();
            $dw_23 = DB::table('launder_withdrow')->where('LAUNDER_WITHDROW_DEP_SUB_SUB_ID','=','23')->where('LAUNDER_WITHDROW_DATE','like',$year.'%')->count();
            $dw_24 = DB::table('launder_withdrow')->where('LAUNDER_WITHDROW_DEP_SUB_SUB_ID','=','24')->where('LAUNDER_WITHDROW_DATE','like',$year.'%')->count();
            $dw_25 = DB::table('launder_withdrow')->where('LAUNDER_WITHDROW_DEP_SUB_SUB_ID','=','25')->where('LAUNDER_WITHDROW_DATE','like',$year.'%')->count();
            $dw_26 = DB::table('launder_withdrow')->where('LAUNDER_WITHDROW_DEP_SUB_SUB_ID','=','26')->where('LAUNDER_WITHDROW_DATE','like',$year.'%')->count();
            $dw_27 = DB::table('launder_withdrow')->where('LAUNDER_WITHDROW_DEP_SUB_SUB_ID','=','27')->where('LAUNDER_WITHDROW_DATE','like',$year.'%')->count();
            $dw_28 = DB::table('launder_withdrow')->where('LAUNDER_WITHDROW_DEP_SUB_SUB_ID','=','28')->where('LAUNDER_WITHDROW_DATE','like',$year.'%')->count();
            $dw_29 = DB::table('launder_withdrow')->where('LAUNDER_WITHDROW_DEP_SUB_SUB_ID','=','29')->where('LAUNDER_WITHDROW_DATE','like',$year.'%')->count();
            $dw_30 = DB::table('launder_withdrow')->where('LAUNDER_WITHDROW_DEP_SUB_SUB_ID','=','30')->where('LAUNDER_WITHDROW_DATE','like',$year.'%')->count();  
            $dw_31 = DB::table('launder_withdrow')->where('LAUNDER_WITHDROW_DEP_SUB_SUB_ID','=','31')->where('LAUNDER_WITHDROW_DATE','like',$year.'%')->count(); 
            $dw_32 = DB::table('launder_withdrow')->where('LAUNDER_WITHDROW_DEP_SUB_SUB_ID','=','32')->where('LAUNDER_WITHDROW_DATE','like',$year.'%')->count(); 
            $dw_33 = DB::table('launder_withdrow')->where('LAUNDER_WITHDROW_DEP_SUB_SUB_ID','=','33')->where('LAUNDER_WITHDROW_DATE','like',$year.'%')->count(); 
            $dw_34 = DB::table('launder_withdrow')->where('LAUNDER_WITHDROW_DEP_SUB_SUB_ID','=','34')->where('LAUNDER_WITHDROW_DATE','like',$year.'%')->count(); 
            $dw_35 = DB::table('launder_withdrow')->where('LAUNDER_WITHDROW_DEP_SUB_SUB_ID','=','35')->where('LAUNDER_WITHDROW_DATE','like',$year.'%')->count(); 
            $dw_36 = DB::table('launder_withdrow')->where('LAUNDER_WITHDROW_DEP_SUB_SUB_ID','=','36')->where('LAUNDER_WITHDROW_DATE','like',$year.'%')->count(); 
            $dw_37 = DB::table('launder_withdrow')->where('LAUNDER_WITHDROW_DEP_SUB_SUB_ID','=','37')->where('LAUNDER_WITHDROW_DATE','like',$year.'%')->count(); 
            $dw_38 = DB::table('launder_withdrow')->where('LAUNDER_WITHDROW_DEP_SUB_SUB_ID','=','38')->where('LAUNDER_WITHDROW_DATE','like',$year.'%')->count(); 
            $dw_39 = DB::table('launder_withdrow')->where('LAUNDER_WITHDROW_DEP_SUB_SUB_ID','=','39')->where('LAUNDER_WITHDROW_DATE','like',$year.'%')->count();      
            $dw_40 = DB::table('launder_withdrow')->where('LAUNDER_WITHDROW_DEP_SUB_SUB_ID','=','40')->where('LAUNDER_WITHDROW_DATE','like',$year.'%')->count(); 
        ...
        return view('manager_launder.dashboard_launder',[
            ...
            'di_20' => $di_20,'di_30' =>$di_30, 'di_40' => $di_40,
