...
function MonthThai($strmonth)
{
 ...
 <div class="modal-header">
    <div class"col-12">
        <div class="row">
            <div class="col-11"><h4  style="font-family: \'Kanit\', sans-serif;">&nbsp;&nbsp;&nbsp;&nbsp;รายละเอียดรายรับ - รายจ่าย '.$salary_all->SALARYALL_PERSON_NAME.' วันที่ '.$salary_all->SALARYALL_DAY_ID.' '.MonthThai($salary_all->SALARYALL_MONTH_ID).' '.$salary_all->SALARYALL_YEAR_ID.' ประเภท '.$typename.'</h4> </div>
            <div class="col-1">
